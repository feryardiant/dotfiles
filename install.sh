...
plugins[editorconfig/editorconfig-vim]=editorconfig
...
plugins[roxma/vim-hug-neovim-rpc]=hug-neovim-rpc
...
plugins[ayu-theme/ayu-vim]=ayu
plugins[matze/vim-move]=move
plugins[posva/vim-vue]=vue
